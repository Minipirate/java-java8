...
public class DateAndTime_02_Test {
    ...
    public void test_localDate_format_with_hour() {
        ...
        result1.format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss"));
    }
    ...
    public void test_with() {
        ...
        LocalDate result1 = localDate.withYear(2015);
        
        LocalDate result2 = result1.with(ChronoField.DAY_OF_MONTH, 05);
        
        LocalDate result = result2.plus(01, ChronoUnit.MONTHS); // ici 01 car la méthode donne +1
